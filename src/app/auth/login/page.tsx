...
export const metadata: Metadata = {
  title: 'Entrar - NutriPlan',
  description: 'Entre na sua conta NutriPlan para acessar seus planos alimentares personalizados.',
}
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950 dark:to-blue-950 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Acesse seus planos alimentares personalizados
          </CardDescription>
        </CardHeader>
