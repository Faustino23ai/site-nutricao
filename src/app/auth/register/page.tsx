...
export const metadata: Metadata = {
  title: 'Criar Conta - NutriPlan',
  description: 'Crie sua conta NutriPlan e comece a gerar planos alimentares personalizados.',
}
...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = async () => {
    try {
      ...
      toast.error('Erro inesperado ao criar conta com Google')
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950 dark:to-blue-950 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Comece sua jornada para uma alimentação saudável
          </CardDescription>
        </CardHeader>
